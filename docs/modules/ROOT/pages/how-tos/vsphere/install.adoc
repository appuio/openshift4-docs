...
export VCENTER_API_URL="https://${VCENTER_HOSTNAME}"
----
...
export VCENTER_API_URL="https://$(ssh ${JUMPHOST_FQDN} dig +short ${VCENTER_HOSTNAME})" <2>
...
[source,bash]
----
curl -kLo vsphere-ca.zip ${VCENTER_API_URL}/certs/download.zip <1>
