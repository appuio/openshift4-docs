...
. Migrate the cluster to `platformType: External` and deploy the Exoscale cloud-controller-manager (CCM) according to the https://hub.syn.tools/exoscale-cloud-controller-manager/how-tos/deploy_ocp.html[Exoscale CCM component how-to]
