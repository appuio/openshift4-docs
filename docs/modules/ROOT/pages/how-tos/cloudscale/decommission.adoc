...
[source,bash]
----
export CLOUDSCALE_TOKEN=<cloudscale-api-token> # From https://control.cloudscale.ch/service/PROJECT_ID/api-token
...
. Delete all volumes in cloudscale.ch project

. Delete backup bucket in cloudscale.ch project
