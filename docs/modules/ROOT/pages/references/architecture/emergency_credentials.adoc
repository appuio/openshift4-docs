...
The credentials are valid for a set period of time.
Exact configuration in `validityDuration`  in https://git.vshn.net/syn/commodore-defaults/-/blob/f23e1a764c0fc3dbb408bfe01df9322eb3d4b6ea/distribution/openshift4/params.yml#L355[params.yaml].
