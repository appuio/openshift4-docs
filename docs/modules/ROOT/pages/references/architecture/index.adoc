...
* xref:references/cloudscale/architecture.adoc[cloudscale.ch]
* xref:references/exoscale/architecture.adoc[Exoscale]
* xref:references/vsphere/architecture.adoc[VMWare vSphere]
* xref:references/openstack/architecture.adoc[OpenStack]
