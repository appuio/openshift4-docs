...
VSHN Managed OpenShift clusters include backups of all Kubernetes manifests and the raw etcd data to a secure location by default. Please note that this is a platform backup and doesn't include application data.
