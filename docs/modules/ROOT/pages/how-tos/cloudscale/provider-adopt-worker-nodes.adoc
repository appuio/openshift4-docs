...
kubectl --as=system:admin apply -f worker-machines.yml
----
...
kubectl --as=system:admin apply -f worker-machineset.yml
----
...
kubectl --as=system:admin apply -f infra-machines.yml
----
...
kubectl --as=system:admin apply -f infra-machineset.yml
----
...
kubectl --as=system:admin apply -f additional-worker-machines.yml
----
...
kubectl --as=system:admin apply -f additional-worker-machinesets.yml
----
