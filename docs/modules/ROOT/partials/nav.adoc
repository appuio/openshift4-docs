...
** xref:oc4:ROOT:explanations/shared_responsibility_model.adoc[]
...
** xref:oc4:ROOT:references/architecture/cluster_access_tooling.adoc[]
...
** xref:oc4:ROOT:references/openstack/architecture.adoc[OpenStack]
...
*** xref:oc4:ROOT:how-tos/cloudscale/replace-master-node.adoc[]
...
*** xref:oc4:ROOT:how-tos/cloudscale/restore-pv-pvc-from-object-backup.adoc[]
...
*** xref:oc4:ROOT:how-tos/exoscale/migrate_to_instancepool.adoc[]
// Node management
*** xref:oc4:ROOT:how-tos/exoscale/replace-master-node.adoc[]
...
** OpenStack
*** xref:oc4:ROOT:references/openstack/architecture.adoc[Architecture]
...
** xref:oc4:ROOT:explanations/decisions/image-registry-backup.adoc[]
** xref:oc4:ROOT:explanations/decisions/app-backup.adoc[]
