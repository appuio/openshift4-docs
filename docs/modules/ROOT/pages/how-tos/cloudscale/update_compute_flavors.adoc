...
Ensure at least version `3.12` of https://github.com/appuio/terraform-openshift4-cloudscale[terraform-openshift4-cloudscale] is used to make sure the flavors for master and loadbalancer nodes get updated as well.
