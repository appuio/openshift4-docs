...
* &nbsp;&nbsp;<<step-16,And I check the cluster domain>>
* &nbsp;&nbsp;<<step-17,And I prepare the cluster repository>>
* <<step-18,Then I configure the OpenShift installer>>
* &nbsp;&nbsp;<<step-19,And I configure Terraform for team "aldebaran">>
* &nbsp;&nbsp;<<step-20,And I configure Terraform for Exoscale>>
* <<step-21,Then I provision the loadbalancers>>
* &nbsp;&nbsp;<<step-22,And I provision the bootstrap node>>
* &nbsp;&nbsp;<<step-23,And I provision the control plane>>
* <<step-24,Then I deploy initial manifests>>
* &nbsp;&nbsp;<<step-25,And I wait for bootstrap to complete>>
* <<step-26,Then I provision the remaining nodes>>
* &nbsp;&nbsp;<<step-27,And I approve and label the new nodes>>
* &nbsp;&nbsp;<<step-28,And I configure initial deployments>>
* &nbsp;&nbsp;<<step-29,And I wait for installation to complete>>
* <<step-30,Then I create the registry S3 secret>>
* &nbsp;&nbsp;<<step-31,And I enable default instance pool annotation injector for LB services>>
* <<step-32,Then I synthesize the cluster>>
* <<step-33,Then I set acme-dns CNAME records>>
* &nbsp;&nbsp;<<step-34,And I verify emergency access>>
* &nbsp;&nbsp;<<step-35,And I configure the cluster alerts>>
* &nbsp;&nbsp;<<step-36,And I enable Opsgenie alerting>>
* &nbsp;&nbsp;<<step-37,And I schedule the first maintenance>>
* <<step-38,Then I configure apt-dater groups for the LoadBalancers>>
* &nbsp;&nbsp;<<step-39,And I remove the bootstrap bucket>>
* &nbsp;&nbsp;<<step-40,And I add the cluster to openshift4-clusters>>
* &nbsp;&nbsp;<<step-41,And I wait for maintenance to complete>>
